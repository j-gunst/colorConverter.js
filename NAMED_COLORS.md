...
| ![#ff1493](https://placehold.co/100x15/ff1493/ffffff?text=DeepPink&font=roboto)             | `#ff1493` | `rgb(255, 20, 147)`  | `hsl(328, 100%, 54%)` |
...
| ![#ff69b4](https://placehold.co/100x15/ff69b4/ffffff?text=HotPink&font=roboto)              | `#ff69b4` | `rgb(255, 105, 180)` | `hsl(330, 100%, 71%)` |
...
| ![#ffb6c1](https://placehold.co/100x15/ffb6c1/000000?text=LightPink&font=roboto)            | `#ffb6c1` | `rgb(255, 182, 193)` | `hsl(351, 100%, 86%)` |
...
| ![#c71585](https://placehold.co/100x15/c71585/ffffff?text=MediumVioletRed&font=roboto)      | `#c71585` | `rgb(199, 21, 133)`  | `hsl(322, 81%, 43%)`  |
...
| ![#d87093](https://placehold.co/100x15/d87093/ffffff?text=PaleVioletRed&font=roboto)        | `#d87093` | `rgb(216, 112, 147)` | `hsl(340, 57%, 64%)`  |
...
| ![#ffc0cb](https://placehold.co/100x15/ffc0cb/000000?text=Pink&font=roboto)                 | `#ffc0cb` | `rgb(255, 192, 203)` | `hsl(350, 100%, 88%)` |
...
const displayMarkdown = () => {
  ...
  Object.values(colors).forEach((item) => {
    ...
    content.insertAdjacentHTML(
      'beforeend',
      `
      | ![${hex}](https://placehold.co/100x15/${hex.slice(1)}/${blackOrWhite(red, green, blue)}?text=${name}&font=roboto) | \`${hex}\` | \`${rgb}\` | \`${hsl}\` |<br />
      `
    )
  })
}
