...
import { HSL_DEFAULT_STRING, RGB_DEFAULT_STRING } from '../src/utils/constants'
...
describe('hexToRgb', () => {
  test.each`
    ...
    ${{ r: '32', g: '28', b: '1e' }} | ${'rgb(50,40,30)'}               | ${false}
    ${{ r: '32', g: '28', b: '1e' }} | ${'rgb(19.6%,15.7%,11.8%)'}      | ${true}
...
describe('hexToHsl', () => {
  test.each`
    ...
    ${{ r: '32', g: '28', b: '1e' }}          | ${'hsl(30,25%,16%)'}
    ${{ r: '80', g: '33', b: '1a', a: '80' }} | ${'hsla(15,66%,30%,50%)'}
